...
const RecastButton: React.FC = () => {
  ...
  return (
    <svg
      ...
      onClick={() => dispatch({ type: "randomizeWand" })}
    ...
    >
      ...
      <g style={{ mixBlendMode: "color-dodge" }} opacity="0.8">
        <path
          ...
          fill="url(#paint1_radial_981_13818)"
          fill-opacity="0.1"
      ...
      <defs>
        ...
        >
          <stop stop-color="#EFEBCE" stop-opacity="0.5" />
          <stop offset="1" stop-color="#EFEBCE" />
        </linearGradient>
        <radialGradient
        ...
        >
          <stop stop-color="#E7EEE2" />
          <stop offset="0.567708" stop-color="#C7E8AF" stop-opacity="0.5" />
          <stop offset="1" stop-color="#66775A" />
        </radialGradient>
        <image
          id="image0_981_13818"
          width="837"
